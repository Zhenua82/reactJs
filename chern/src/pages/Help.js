...
function Help(){
    return(
        <>
            ...
            <img src={imgSlideHelp1} alt="Word" className={styles.imgHome} />
            <div className={styles.container}>
                <div className={styles.instruct}>
                    ...
                    <img src={img11} alt="1" className={styles.imgHelp} />
                </div>
                <div className={styles.instruct}>
                    ...
                    <img src={img22} alt="2" className={styles.imgHelp} />
                </div>
                <div className={styles.instruct}>
                    ...
                    <img src={img33} alt="3" className={styles.imgHelp} />
                </div>
                <div className={styles.instruct}>
