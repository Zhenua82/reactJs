function VyvodyUshibRanaOgr(){
    return (
        <p id="MsoBodyTextIndent" className="blue">Рана правой половины затылочной области является ушибленной,  о чем  свидетельствуют неровные,  осаднённые,  кровоподтечные края, наличие разрывов кожи на концах раны, и наличие в глубине раны тканевых перемычек.    
