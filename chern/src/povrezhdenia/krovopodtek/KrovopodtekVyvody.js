function KrovopodtekVyvody(){
    return (
        <p id="MsoBodyTextIndent" className="blue"> Кровоподтек носит травматический характер и образовался в результате взаимодействия (каким могло быть удар, давление, 
        сдавление, растяжение) с твёрдым тупым предметом (или предметами), что подтверждается самим видом повреждения. Местом приложения травмирующей силы при образовании 
