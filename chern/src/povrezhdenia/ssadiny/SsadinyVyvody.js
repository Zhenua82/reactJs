function SsadinyVyvody(){
    return (
        <p id="MsoBodyTextIndent" className="blue"> Имеющиеся у N ссадины носят травматический характер и образовались, в результате взаимодействий (какими могли быть удар, давление, сдавление, трение) с твёрдым тупым предметом (или предметами), что подтверждается самим видом повреждений.
